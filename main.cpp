...
//Call the classes created
        ...
        //cin >> Filepath;
        Filepath = "/Users/karimfady/Downloads/module (2).v";
        ...
        //cin >> Filepath;
        Filepath = "/Users/karimfady/Downloads/stimuli (2).stim";
        ...
        //cin >> Filepath;
        Filepath = "/Users/karimfady/Downloads/Simulation.sim";
        //Setting the Stimuli File Path in the File Class
        f.SetFilePath(Filepath);
        //Writing the output vector into the Simulation File
        f.writeVectorToFile(output);

        Simulator w(2224,"/Users/karimfady/Downloads/Simulation.sim",m.GetInputs());
        w.show();
    return a.exec();
}
